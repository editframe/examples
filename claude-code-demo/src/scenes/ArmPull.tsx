...
export const ArmPull: React.FC = () => {
  ...
  return (
    <Timegroup mode="fixed" duration="6.5s" onFrame={handleFrame as any} className="absolute inset-0">
      ...
      <Audio src="/claude-code-demo/src/assets/sfx/punch-whoosh.wav" offset="1100ms" duration="0.55s" volume={1} />
      <Audio src="/claude-code-demo/src/assets/sfx/punch-whoosh.wav" offset="2100ms" duration="0.55s" volume={1} />
      <Audio src="/claude-code-demo/src/assets/sfx/punch-whoosh.wav" offset="3100ms" duration="0.55s" volume={1} />
      <Audio src="/claude-code-demo/src/assets/sfx/punch-whoosh.wav" offset="4100ms" duration="0.55s" volume={1} />
    </Timegroup>
  );
};

export default ArmPull;
