 ...
 *           App only reveals when camera has fully panned back out (AppLaunch).
 ...
 * panels resizing toward their AppLaunch targets during the pull-out) — converted to a
...
export const RunZoom: React.FC = () => {
  return (
    ...
    >
      ...
      {/* Camera container — SAME origin as AgentWorking ("top left") for the whole scene so
      ...
      >
        ...
        {/* NOTE: TicTacToe is NOT rendered here (FIX 5).
            It appears in AppLaunch as if it was already open when camera panned back. */}
...
(RunZoom as any).duration = SCENE_DURATION;
