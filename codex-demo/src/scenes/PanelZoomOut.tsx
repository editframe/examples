 ...
 *
 * FIX A (Round 6): Starts from full-screen white (continuation of SendTransition's fade-to-white).
 ...
 * Xcode window as the camera pulls back. This is ONE seamless transition from SendTransition.
 *
...
export const PanelZoomOut: React.FC = () => {
...
(PanelZoomOut as any).duration = SCENE_DURATION;
