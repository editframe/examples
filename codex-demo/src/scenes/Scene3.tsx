 ...
 * - NO sliding, NO shrinking, NO desktop bg reveal — that happens in Scene4
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Chat input — same position as Scene2: top:310 */}
          <div
            style={{
              position: "absolute",
              top: 310,
          ...
          {/* Filter chips — same position as Scene2: top:560, left:285.
              borderRadius:8 to match Scene2 exactly (NOT rounded pill). */}
          <div style={{
            position: "absolute",
            top: 560,
            left: 285,
          ...
          {/* Suggestion pills — same position as Scene2: top:630, left:285 */}
          <div style={{
            position: "absolute",
            top: 630,
            left: 285,
...
(Scene3 as any).duration = SCENE_DURATION;
