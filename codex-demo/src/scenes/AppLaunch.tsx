 ...
 *
 * RunZoom already ends at scale(1.0) with windows in AppLaunch positions — hold steady, no
...
export const AppLaunch: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Main content container — RunZoom already eased out to scale(1.0), just hold steady */}
      <div
        style={{
          position: "absolute",
          inset: 0,
...
(AppLaunch as any).duration = SCENE_DURATION;
