...
export function CreateEnv() {
  return (
    ...
    >
      ...
      {!TRACE_MODE && (
        <Image
          src="/cursor-cloud-agents-demo/src/assets/gradient-bg-v5.png"
          style={{
            position: "absolute",
            inset: 0,
            width: 1920,
      ...
      <Audio src="/cursor-cloud-agents-demo/src/assets/sfx/cursor-cloud-agents-demo-click.mp3" offset="1500ms" sourceIn="0.6s" duration="0.3s" volume={1} />
    </Timegroup>
  );
}

CreateEnv.duration = DURATION;
