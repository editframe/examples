...
export const SCROLL_START = 1850;        // motion blur scroll begins (right after hard cut)
export const SCROLL_END = 1990;          // scroll settles BEFORE r02@2.0s (crisp settled scored best)
