...
# 20.03s video. Music bed loudnorm-normalized, fade in 0.6s, fade out over the last 1.5s.
ffmpeg -y -hide_banner -v error \
  -i "$VIN" \
  -i "$MUSIC" \
  -filter_complex "
    [1:a]atrim=duration=20.03,asetpts=PTS-STARTPTS,
         loudnorm=I=-16:TP=-1.5:LRA=11,
         afade=t=in:st=0:d=0.6,
         afade=t=out:st=18.53:d=1.5,
