...
import { track, lerp, typewriter } from "@shared/utils/animation";
...
export function AIChatPanel() {
  ...
  return (
    ...
    >
      ...
      <Audio src="/vercel-knowledge-base-demo/src/assets/sfx/vercel-knowledge-base-demo-keyboard.wav" offset="1500ms" duration="1.5s" volume={0.7} />
      {/* Thumbs-up click (TU_CLICK = 13060ms local, see onFrame above) */}
      <Audio src="/vercel-knowledge-base-demo/src/assets/sfx/vercel-knowledge-base-demo-click.mp3" offset="13060ms" sourceIn="0.6s" duration="0.3s" volume={1} />
    </Timegroup>
  );
}
