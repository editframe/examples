...
export type RevealProps = {
   ...
   *   the scene boundary (or whose duration doesn't match the sequence's overlap).
 ...
 *
 * `enter`/`exit` are local to the enclosing scene's own `Timegroup mode="fixed"` clock —
 * small, human-scale numbers instead of master-ms. Use this for one-shot "float up + fade
 * in, later fade out" callouts; keep continuous/procedural motion as infinite CSS keyframes
