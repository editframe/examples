...
> **This template specifically uses the subtle paper `#DEDCD2` canvas variant** instead of the default sage `#C5DABF`. Everything else (ink, coral, card surface) is identical to the sage variant.

| Token | Hex | Use |
|---|---|---|
| Sage paper | `#C5DABF` | Primary canvas (default Claude variant). |
| Subtle paper | `#DEDCD2` | **This template's canvas.** Editorial, neutral, slightly warmer than sage. |
