...
demos=(
  figma-agent-demo figma-motion-demo vercel-deploy-demo vercel-knowledge-base-demo
  ...
  chatgpt-voice-demo codex-demo elevenlabs-montage-demo elevenlabs-vocals-demo
  higgsfield-mcp-demo higgsfield-figma-demo grokbot-android-demo grokbot-more-plans-demo
  grokbot-templates-demo grokbot-to-buy-demo ramplabs-demo firecrawl-demo
  cursor-router-demo alchemy-demo
