...
export function LogoOutro() {
  return (
    ...
    >
      ...
      {/* Corner twinkle — reuses the same infinite-loop pattern as AssetsIntro's pixels
          (shared `pixel-twinkle` keyframe; fade fractions collapsed to match AssetsIntro's
...
LogoOutro.duration = SCENE_DURATION;
